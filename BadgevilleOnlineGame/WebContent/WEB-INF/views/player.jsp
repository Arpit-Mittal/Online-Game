...
<body>
	...
	<input type="button" value="Start a discussion" onclick="Badgeville.credit('Start a discussion')"/>
	<input type="button" value="Comment" onclick="Badgeville.credit({verb:'comment', forum:'sports'})"/>
...
window.BadgevilleAsynchInit = function() {
    ...
    Badgeville.Gears.reward( 
        Badgeville.p().last_reward 
